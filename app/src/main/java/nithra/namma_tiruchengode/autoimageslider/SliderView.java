...
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.PageIndicatorView;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.animation.type.BaseAnimation;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.animation.type.ColorAnimation;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.animation.type.IndicatorAnimationType;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.draw.controller.AttributeController;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.draw.controller.DrawController;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.draw.data.Orientation;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.draw.data.RtlMode;
import nithra.namma_tiruchengode.autoimageslider.IndicatorView.utils.DensityUtils;
import nithra.namma_tiruchengode.autoimageslider.InfiniteAdapter.InfinitePagerAdapter;
import nithra.namma_tiruchengode.autoimageslider.Transformations.AntiClockSpinTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.Clock_SpinTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.CubeInDepthTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.CubeInRotationTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.CubeInScalingTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.CubeOutDepthTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.CubeOutRotationTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.CubeOutScalingTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.DepthTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.FadeTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.FanTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.FidgetSpinTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.GateTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.HingeTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.HorizontalFlipTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.PopTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.SimpleTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.SpinnerTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.TossTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.VerticalFlipTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.VerticalShutTransformation;
import nithra.namma_tiruchengode.autoimageslider.Transformations.ZoomOutTransformation;
...
public class SliderView extends FrameLayout
    ...
    private final Handler mHandler_start = new Handler();
    private final Handler mHandler_auto = new Handler();
    private Runnable runnable_start = null;
    private Runnable runnable_auto = null;
    ...
    private void setupSlideView(Context context) {
        ...
        mSliderPager.setPadding(40, 0, 40, 40);
        mSliderPager.setClipToPadding(false);
    ...
    public void startAutoCycle() {
        ...
        if (runnable_start == null) {
            mHandler_start.postDelayed(runnable_start = new Runnable() {
                @Override
                public void run() {
                    mSliderPager.setCurrentItem(mSliderPager.getCurrentItem(), false);
                }
            }, 1000);
        }
    }
    ...
    public void stopAutoCycle() {
        //clean callback
        mHandler.removeCallbacks(this);
        if (runnable_auto != null) {
            mHandler_auto.removeCallbacks(runnable_auto);
            runnable_auto = null;
        }
        if (runnable_start != null) {
            mHandler_start.removeCallbacks(runnable_start);
            runnable_start = null;
        }
    }
    ...
    public void slideToNextPosition() {
        ...
        if (adapterItemsCount > 1) {
            ...
            if (mAutoCycleDirection == AUTO_CYCLE_DIRECTION_RIGHT) {
                mSliderPager.setCurrentItem(currentPosition + 1, true);
                System.out.println("current item : " + currentPosition + "   :  " + (currentPosition + 1));
                if (currentPosition == (getAdapterItemsCount() - 1)) {
                    mHandler_auto.postDelayed(runnable_auto = new Runnable() {
                        @Override
                        public void run() {
